...
WebUI.click(findTestObject('Page_WOLF/button_Attachment'), FailureHandling.STOP_ON_FAILURE)

WebUI.uploadFile(findTestObject(null), '')

WebUI.click(findTestObject('Object Repository/Page_WOLF/button_Upload'))
