...
WebUI.click(findTestObject('Object Repository/Page_WOLF/div_Cancelled'))

WebUI.verifyEqual(findTestObject('Object Repository/Page_WOLF/span_Cancelled'), 'Cancelled')
